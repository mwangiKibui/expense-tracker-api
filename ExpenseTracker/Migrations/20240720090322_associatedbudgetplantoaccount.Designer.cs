...
namespace ExpenseTracker.Migrations
{
    ...
    [Migration("20240720090322_associatedbudgetplantoaccount")]
    partial class associatedbudgetplantoaccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpenseTracker.Models.BudgetPlan", b =>
                {
                    b.HasOne("ExpenseTracker.Models.Account", "Account")
                        .WithOne("BudgetPlan")
                        .HasForeignKey("ExpenseTracker.Models.BudgetPlan", "AccountID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
